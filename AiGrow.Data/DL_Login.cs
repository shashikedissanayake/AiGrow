...
namespace AiGrow.Data
{
    public class DL_Login
    {
        public int insert(AiGrow.Model.ML_Login login)
        {
            ...
            object returnVal = MySQLHelper.ExecuteScalar(DBConnection.connectionString, System.Data.CommandType.Text, "INSERT INTO chargenet.login (id_user , logged_in_timestamp , login_mode , login_token) VALUES (@userID, NOW(), @loginMode, @loginToken);SELECT LAST_INSERT_ID();", para);
